...
#' WMWS3 object
#' 
#' Constructor for \code{WMWS3} S3 object.
#' 
...
#' Returns a \code{WMWS3} object.
#' 
#' @param x Vector containing data for the first label.
#' @param y Vector containing data for the second label.
#' @param alpha Significance threshold.
#' @details Computes the Wilcoxon-Mann-Whitney statistic and returns a 
#'          \code{WMWS3} object for two numeric vectors.
#' @return \code{WMWS3} object.
#' @export
